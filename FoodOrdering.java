...
class Desserts extends JFrame implements ActionListener
{
	...
	Desserts()
	{
		...
		b1.setBounds(125,750,100,30);
		b2.setBounds(730,750,130,30);
		add(limage);
		limage.add(d);
		limage.add(m1);
		limage.add(p1);
...
class Drinks extends JFrame implements ActionListener
{
	...
	Drinks()
	{
		...
		b1.setBounds(50,750,100,30);
		b2.setBounds(680,750,130,30);
		add(limage);		
		limage.add(d);
		limage.add(m1);
		limage.add(p1);
	...
	italy_veg()
	{
	   ...
	   c24=new JCheckBox("White Pesto Pasta--------RS280");
        ...
        c1.setBounds(210,150,250,30);
		 ...
		 b1.setBounds(210,750,100,30);
		 b2.setBounds(740,750,130,30);
		  b1.addActionListener(this);
		  b2.addActionListener(this);
		 add(limage);
		limage.add(l1);
	...
	mexican_veg()
	{
	   ...
	   c24=new JCheckBox("blue corn nachos--------RS280");
		...
		c24.setContentAreaFilled(false);
		 ...
		 b1.setBounds(170,750,100,30);
		 b2.setBounds(700,750,130,30);
		 limage.setBounds(0,0,1000,1000);
	...
	Indianveg()
	{
	   ...
	   c24=new JCheckBox("Jeera-Rice--------------------RS80");
		...
		c24.setContentAreaFilled(false);
		 ...
		 b1.setBounds(300,750,100,30);
		 b2.setBounds(830,750,130,30);
		 b1.addActionListener(this);
		 b2.addActionListener(this);
		 add(limage);
		 limage.add(l1);
...
class Test extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(username.equals("vedansh")&&passw.equals("123"))
		{
		...
		else if(username.equals("diya")&&passw.equals("123"))
		{
			if(e.getActionCommand().equals("Login"))
				{
					this.setVisible(false);
		...
		else if(username.equals("ritika")&&passw.equals("123"))
		{
			if(e.getActionCommand().equals("Login"))
				{
					this.setVisible(false);
